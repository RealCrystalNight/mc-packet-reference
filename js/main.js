...
function renderDetail(p) {
  ...
  headerHtml += '<a href="/mc-packet-reference/packets/' + p.id + '/" class="detail-permalink" title="Share this link for rich embeds on Discord/Twitter" target="_blank"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg> Share this packet (rich embed)</a>';
